...
"AutoDeleteIn" = "auto-delete in {time}";
...
"OpenUrlWarning" = "This link contains misleading characters or hides its real destination. Be careful when opening it.";
"OpenUrlConfirm" = "Open";
...
"EphemeralRevert" = "Revert";
"EphemeralRevertDescription" = "Restores the message to its original content";
"EphemeralAnchoredNotice" = "This version of the message is only visible to you.";
"EphemeralUpdated" = "updated";
...
"EditAdminManageWelcomeMessages" = "Manage Welcome Messages";
...
"SettingsPasscodeStart1" = "When a passcode is set, a lock icon appears above your chat list. Tap it to lock your Telegram.";
"SettingsPasscodeStart2" = "Note: if you forget your local passcode, you'll need to log out.";
"PasscodeTooManyAttempts" = "Too many attempts. Please try again later.";
"PasscodeUsePasskey" = "Unlock with Passkey";
"PasscodePasskeyTitle" = "Passkey";
"PasscodePasskeyName" = "Local Passcode";
"PasscodePasskeyEnable" = "Set Up Passkey";
"PasscodePasskeyDescription" = "Use your fingerprint, face, or device PIN instead of typing the passcode.";
"PasscodePasskeyError" = "Passkey unlock failed. Please use your passcode.";
"PasscodePasskeyUnsupported" = "Your device or browser does not support passkey unlock.";
"PasscodePasskeyRemovedChange" = "Your passkey was removed because the passcode changed. Add it again to keep using passkey unlock.";
"PasscodeLockScreenTitle" = "Lock Screen";
"PasscodeKeepBackground" = "Keep Background";
"PasscodeKeepBackgroundInfo" = "Show your background image on the lock screen";
"PasscodeAutoLockTitle" = "Auto-Lock";
"PasscodeAutoLockDisabled" = "Disabled";
"PasscodeAutoLock1Min" = "If away for 1 minute";
"PasscodeAutoLock5Min" = "If away for 5 minutes";
"PasscodeAutoLock30Min" = "If away for 30 minutes";
"PasscodeAutoLock1Hour" = "If away for 1 hour";
"PasscodeDataCorrupted" = "Your encrypted data could not be restored. To continue using Telegram, log out of all accounts and log in again.";
"PasscodeLogOutAllAccounts" = "Log Out All Accounts";
"PasscodeLogOutAllConfirm" = "Remove all accounts and local data from this browser? These sessions will remain active until you terminate them in Settings > Devices.";
"PasscodeForgotHelp" = "Note: if you forget your passcode, you'll need to {logOut}.";
"PasscodeForgotHelpLink" = "log out from all accounts";
...
"AudioOpenPlaylist" = "Playlist";
"AudioRepeatOff" = "Repeat off";
"AudioRepeatList" = "Repeat list";
"AudioRepeatSong" = "Repeat song";
"AudioPlaybackOrder" = "Playback order";
"AudioShuffleList" = "Shuffle list";
"AudioReverseOrder" = "Reverse order";
"AudioShowInChat" = "Show in Chat";
"AudioVolume" = "Volume";
"AudioPlaybackRate" = "Playback speed";
...
"PasscodeSwitchToKInfo" = "To switch to the K version, disable your local passcode first.";
...
"Playlist" = "Playlist";
"PlaylistTitle" = "{peer}'s Playlist";
"PlaylistYourTitle" = "Your Playlist";
...
"ProfileTabGifs" = "GIF";
"ProfileTabPolls" = "Polls";
"ProfilePollsEmpty" = "No polls yet";
...
"ToDoListTasksLimitReached" = "Maximum number of tasks reached.";
"ToDoListTasksTitle" = "Tasks";
...
"AudioForwardedToChat" = "Audio forwarded to a chat";
"AudioForwardedToSaved" = "Audio forwarded to **Saved Messages**";
...
"WebLoginInvalid" = "This login link is invalid or has expired. Open a fresh link or log in normally.";
"RichButtons" = "Buttons";
"RichButtonInline" = "Inline Button";
"RichButtonRow" = "Button Row";
"RichButtonEdit" = "Edit Button";
"RichButtonAdd" = "Add Button to Row";
"RichButtonRemove" = "Remove Button";
"RichButtonEarlier" = "Move Button Earlier";
"RichButtonLater" = "Move Button Later";
"RichButtonAction" = "Action";
"RichButtonUrl" = "Open Link";
"RichButtonProfile" = "Open Profile";
"RichButtonCopy" = "Copy Text";
"RichButtonDisabled" = "Disabled";
"RichButtonUserId" = "User ID";
"RichButtonSelectUser" = "Select User";
"RichButtonUnknownUser" = "Choose a user whose profile you have opened.";
"RichButtonInvalidUrl" = "Enter a valid URL.";
"RichButtonStyle" = "Style";
"RichButtonDefault" = "Default";
"RichButtonPrimary" = "Primary";
"RichButtonDanger" = "Danger";
"RichButtonSuccess" = "Success";
"RichButtonAlign" = "Alignment";
"RichButtonStretch" = "Stretch";
"RichButtonLeft" = "Left";
"RichButtonCenter" = "Center";
"RichButtonRight" = "Right";
"RichEditorButtonCopyText" = "Text to copy";
`;export{e as default};
//# sourceMappingURL=fallback-BjfPz1lf.js.map