...
export default {
  ...
  "LoginSessionString": "Log in with Session String",
  "LoginSessionStringTitle": "Log in to Telegram by Session String",
  "LoginSessionStringDescription": "Paste a GramJS session string to sign in without a login code.",
